...
let girilenNot = prompt('Lütfen notunuzu giriniz.')
let info = document.querySelector("#greating")
let textInfo;   
...
{   
    ...
    if (girilenNot >= 90)
        textInfo += " AA"
    else if (girilenNot >= 85 && girilenNot <= 89)
        textInfo += " BB"
    else if (girilenNot >= 80 && girilenNot <= 84)
        textInfo += " CB"
    else if (girilenNot >= 75 && girilenNot <= 79)
        textInfo += " CC"
    else if (girilenNot >= 65 && girilenNot <= 69)
        textInfo += " DC"
    else if (girilenNot >= 60 && girilenNot <= 64)
        textInfo += " DD"
    else if (girilenNot >= 50 && girilenNot <= 59)
        textInfo += " FD"
    else if (girilenNot <= 49){
        textInfo = `${SAD} FF`
    ...
    textInfo += "Lüten 0 ile 100 arasında sayısal bir değer giriniz."
}

 info.innerHTML = ` ${girilenNot}  ${textInfo} `
